...
import { UpdateSociety, imageUploadURL, mainEndpoint } from "../endPointUrls";
...
const UpdateSocietyFormComponent = ({ societyData, setModalStatus}) => {
    ...
    useEffect(() => {
        // Pre-fill the form with existing society data
        if (societyData) {
            setData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const updatedSocietyData = {
                ...data,
                image: imageUrl ? `${mainEndpoint}/${imageUrl}` : data.image, // Use new image if uploaded, otherwise keep the old one
            };
